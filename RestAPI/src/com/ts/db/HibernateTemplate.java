...
public class HibernateTemplate {
	...
	String queryString = "from Employee where email = :userName";
	...
	public static Object getObjectByUser(String userName, String password) {
		
		String queryString = "from User where emailId = :userName and password = :password";
		  Query query = sessionFactory.openSession().createQuery(queryString);
		  query.setString("userName", userName);
